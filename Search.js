    ...
    return (
        <>
            ...
            <View style={styles.header}>
                <TextInput placeholder="Search..." onChangeText={(e) => setperson(e)} style={styles.Heading2} ></TextInput>
                ...
                {
                    allow1===false ? <Text>No users found</Text> : null
                }
            ...
            <ScrollView >
                ...
                <View >
                    ...
                    {
                        allow1 ? <View style={styles.content}>
                            {
                                userdp.map((e) => {
                                    if (e.username === person) {
                                        return (
                                            <Image source={{ uri: e.userdp }} style={styles.imageStyle} onPress={() => navigation.navigate('Profile2', { username: person })} />
                                        )
                                    }
                                })
                            }
                            <Text style={styles.text} onPress={() => navigation.navigate('Profile2', { username: person })}>{person} </Text>
                            <Text style={styles.text1} onPress={() => {
                                axios.post("http://192.168.128.218:3003/updateFrnd1", { params: { rname: person, Requestlist: username } }).then((res) => {
