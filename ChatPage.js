...
export default function ChatPage({ username }) {
    ...
    function SubmitRoom() {
        setvisible(false)
        axios.post("http://192.168.128.218:3003/addroom", { room }).then((res) => {
            console.log(res)
        }).catch((e) => {
            console.log(e)
        })
    ...
    function GetRoom() {
        axios.get("http://192.168.128.218:3003/getroom").then((res) => {
            console.log(res)
    ...
    function AddFriend() {
        ...
        UserList.map((e, id) => {
            ...
            return (<View key={id}>
                {
                    FriendName === e.Name ?
                        axios.post("http://192.168.128.218:3003/addfrnd", { username, FriendName }).then((res) => console.log(res))
                            .catch((err) => { console.log(err) })
    ...
    function AddPost(){
        axios.post("http://192.168.128.218:3003/addpost",{username,Post}).then((res)=>{
    ...
    useEffect(() => {
        axios.get("http://192.168.128.218:3003/getmsg").then((res) => {
